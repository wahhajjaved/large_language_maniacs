...
class PackageController(base.BaseController):
    ...
    def search(self):
        ...
        package_type = pkgcontroller._guess_package_type()
        ...
        return render(pkgcontroller._search_template(package_type),
    ...
    def resources(self, id):
        ...
        pkgcontroller._setup_template_variables(context, {'id': id},
                                       package_type=package_type)
    ...
    def read(self, id):
        ...
        for resource in c.pkg_dict['resources']:
            ...
            resource['can_be_previewed'] = pkgcontroller._resource_preview(
        ...
        template = pkgcontroller._read_template(package_type)
        try:
    ...
    def history(self, id):
        ...
        return render(
            pkgcontroller._history_template(c.pkg_dict.get('type', package_type)),
            extra_vars={'dataset_type': package_type})
    ...
    def resource_edit(self, id, resource_id, data=None, errors=None,
        ...
        if request.method == 'POST' and not data:
            ...
            try:
                ...
                return pkgcontroller.resource_edit(id, resource_id, data,
        ...
        if pkg_dict['state'].startswith('draft'):
            ...
            return pkgcontroller.new_resource(id, data=data)
        ...
        vars = {'data': data, 'errors': errors,
                ...
                'resource_form_snippet': pkgcontroller._resource_form(package_type),
                'dataset_type': package_type}
    ...
    def new_resource(self, id, data=None, errors=None, error_summary=None):
        ...
        if request.method == 'POST' and not data:
            ...
            if not data_provided and save_action != "go-dataset-complete":
                ...
                if not len(data_dict['resources']):
                    ...
                    if asbool(config.get('ckan.legacy_templates')):
                        ...
                        return pkgcontroller.new_resource(id, data, errors,
                                                 error_summary)
            ...
            try:
                ...
                errors = e.error_dict
                error_summary = e.error_summary
                return pkgcontroller.new_resource(id, data, errors, error_summary)
            except NotAuthorized:
    ...
    def edit(self, id, data=None, errors=None, error_summary=None):
        package_type = pkgcontroller._get_package_type(id)
        context = {'model': model, 'session': model.Session,
                   'user': c.user, 'auth_user_obj': c.userobj,
                   'save': 'save' in request.params}

        if context['save'] and not data:
            return pkgcontroller._save_edit(id, context, package_type=package_type)
        try:
        ...
        if data.get('state', '').startswith('draft'):
            ...
            c.form_style = 'new'
            return pkgcontroller.new(data=data, errors=errors,
                            error_summary=error_summary)
        ...
        edit_template = pkgcontroller._edit_template(package_type)
	...
	##CALCULANDO LA CALIDAD DE LOS DATOS
	    ...
	    #data_dict['notes'] = data_dict
            ...
            pkgcontroller._form_save_redirect(pkg_dict['name'], 'new',
                                     package_type=package_type)
        except NotAuthorized:
            abort(403, _('Unauthorized to read package %s') % '')
        except NotFound, e:
    ...
    def _save_edit(self, name_or_id, context, package_type=None):
        ...
        try:
            ...
            pkgcontroller._form_save_redirect(pkg['name'], 'edit',
                                     package_type=package_type)
        except NotAuthorized:
            ...
            errors = e.error_dict
            error_summary = e.error_summary
            return pkgcontroller.edit(name_or_id, data_dict, errors, error_summary)
    ...
    def resource_delete(self, id, resource_id):
        ...
        return render('package/confirm_delete_resource.html',
                      {'dataset_type': pkgcontroller._get_package_type(id)})
    ...
    def resource_read(self, id, resource_id):
        ...
        c.resource['can_be_previewed'] = pkgcontroller._resource_preview(
        ...
        template = pkgcontroller._resource_template(dataset_type)
        return render(template, extra_vars=vars)
    ...
    def resource_embedded_dataviewer(self, id, resource_id,
        ...
        recline_state = pkgcontroller._parse_recline_state(request.params)
    ...
    def resource_views(self, id, resource_id):
        package_type = pkgcontroller._get_package_type(id.split('@')[0])
        context = {'model': model, 'session': model.Session,
                   'user': c.user, 'for_view': True,
                   'auth_user_obj': c.userobj}
        data_dict = {'id': id}
